...
export default class FooterTabs extends Component {
  render() {
    ...
    return (
      <div id='fm'>
        <div id='fm-info-title' className='fm-title'>Our Info</div>
        <div id='fm-info-body' className='fm-tab-content'>
          <div id='fm-info-1' className='fm-info-box'>
            <span>Pretty Good Inc, DBA</span>
            <span>Happy Wife Junk Services</span>
          </div>
          <div id='fm-info-2' className='fm-info-box'>
            <span>1820 Tree Top Way</span>
            <span>Marietta, GA 30062</span>
          </div>
          <div id='fm-info-3' className='fm-info-box'>
